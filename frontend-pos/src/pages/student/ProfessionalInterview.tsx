...
import {
  ...
  Info, Activity, Monitor, Globe, Code2
} from 'lucide-react';
...
export default function ProfessionalInterview() {
  ...
  const assignedProfessional = myApplication?.assignedProfessionalId
    ? professionals.find(p => p.id === myApplication.assignedProfessionalId || p._id === myApplication.assignedProfessionalId)
    : null;
  ...
  if (isAppLoading) {
    return (
      <DashboardLayout title="Neural Uplink" subtitle="Acquiring Technical communication channel...">
  ...
  return (
    <DashboardLayout title="Neural Uplink" subtitle="Advanced Technical Evaluation Round">
      <div className="max-w-[1200px] mx-auto space-y-12 pb-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          <div className="lg:col-span-8 space-y-10">
            ...
            {/* Guidelines Card (Visible in all states) */}
            <Card className="border-slate-200 shadow-sm rounded-[3rem] bg-white p-10 border">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-6">
                {[
                  { topic: "Sync early", desc: "Join meeting 5m prior for hardware calibration" },
                  { topic: "Link Stability", desc: "Ensure camera/mic are active and optimized" },
                  { topic: "Logic Access", desc: "Have resumes and architectural projects ready" },
                  { topic: "Active Inquiry", desc: "Prepare strategic questions for the analyst" }
                ].map((item, i) => (
                  ...
                  <div className="flex flex-col items-center text-center space-y-4">
                    <div className="relative">
                      ...
                      <Avatar className="h-24 w-24 rounded-[2rem] border-4 border-white shadow-xl relative z-10 transition-transform hover:scale-105 duration-500">
                        {assignedProfessional.avatar ? <AvatarImage src={assignedProfessional.avatar} /> : null}
